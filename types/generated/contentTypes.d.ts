...
export interface ApiDomainDomain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['public', 'custom']> &
...
export interface ApiLinkLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    geo_targeting: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::link.link'> &
      Schema.Attribute.Private;
    original_url: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    users_permissions_user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    verified_safe: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
  };
}
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    plan_type: Schema.Attribute.Enumeration<
      ['free', 'tool', 'bundle', 'annual', 'quarterly']
    > &
